...
func TestBuildArgs_MySQL(t *testing.T) {
	...
	got := devexec.BuildArgs("mysql", "mysql-8-0", ds, project.Secrets{}, "myapp", nil)
...
func TestBuildArgs_MariaDB(t *testing.T) {
	...
	got := devexec.BuildArgs("mariadb", "mariadb-latest", ds, project.Secrets{}, "shop", nil)
...
func TestBuildArgs_Percona(t *testing.T) {
	...
	got := devexec.BuildArgs("percona", "percona-8-0", ds, project.Secrets{}, "blog", nil)
...
func TestBuildArgs_Postgres(t *testing.T) {
	...
	got := devexec.BuildArgs("postgres", "postgres-16", ds, project.Secrets{}, "api", nil)
...
func TestBuildArgs_Mongo(t *testing.T) {
	...
	got := devexec.BuildArgs("mongo", "mongo-latest", ds, project.Secrets{}, "data", nil)
...
func TestBuildArgs_Redis(t *testing.T) {
	...
	got := devexec.BuildArgs("redis", "redis-latest", global.DockerSecrets{}, ps, "myapp", nil)
...
func TestBuildArgs_RedisNoIndex(t *testing.T) {
	got := devexec.BuildArgs("redis", "redis-latest", global.DockerSecrets{}, project.Secrets{}, "myapp", nil)
...
func TestBuildArgs_Unknown(t *testing.T) {
	got := devexec.BuildArgs("mailpit", "mailpit-latest", global.DockerSecrets{}, project.Secrets{}, "myapp", nil)
	want := []string{"bash"}
	if !reflect.DeepEqual(got, want) {
		t.Errorf("got %v, want %v", got, want)
	}
...
func TestBuildArgs_ExtraFlags(t *testing.T) {
	ds := global.DockerSecrets{"mysql-8-0": {"root_password": "secret123"}}
	got := devexec.BuildArgs("mysql", "mysql-8-0", ds, project.Secrets{}, "myapp", []string{"-e", "SELECT 1"})
	want := []string{"mysql", "-u", "root", "-psecret123", "myapp", "-e", "SELECT 1"}
	if !reflect.DeepEqual(got, want) {
		t.Errorf("got %v, want %v", got, want)
	}
}

func TestBuildArgs_ExtraFlagsRedis(t *testing.T) {
	ps := project.Secrets{"redis": {"db_index": "3"}}
	got := devexec.BuildArgs("redis", "redis-latest", global.DockerSecrets{}, ps, "myapp", []string{"KEYS", "*"})
	want := []string{"redis-cli", "-n", "3", "KEYS", "*"}
	if !reflect.DeepEqual(got, want) {
		t.Errorf("got %v, want %v", got, want)
	}
}
